...
<head>
  ...
  <title>Naveed Khan | Portfolio</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <section id="about">
    ...
    <div class="about-grid">
      ...
      <div class="about-text glass" style="padding: 36px;">
        <p>Hey! I'm Naveed, a passionate developer based in San Francisco. I love crafting clean, user-friendly interfaces and building robust web applications.</p>
  ...
  <section id="contact">
    ...
    <div class="contact-box glass">
      ...
      <div class="contact-links">
        <a href="mailto:naveed@example.com">Email</a>
  ...
  <footer>
    <p>© 2026 Naveed Khan. Crafted with ❤️ and glassmorphism.</p>
  </footer>
</body>
</html>
